  ...
  return (
    <LegalPage title="Kişisel Verilerin Korunması (KVKK) Aydınlatma Metni">
      ...
      <ul>
        ...
        <li>MERSİS No: {LEGAL.mersisNo}</li>
      </ul>
      ...
      <ul>
        <li><b>Supabase</b> (veritabanı, kimlik doğrulama, dosya depolama) — AB (Frankfurt) bölgesi</li>
        <li><b>iyzico / iyzi Ödeme ve Elektronik Para Hizmetleri A.Ş.</b> (ödeme) — Türkiye</li>
        <li><b>Vercel</b> (site barındırma) — bölgesel sunucular</li>
        <li><b>Brevo (Sendinblue)</b> (işlem e-postaları) — AB</li>
        <li><b>Cloudflare</b> (bot koruması / Turnstile), <b>Sentry</b> (hata izleme), <b>Upstash</b> (hız sınırlama)</li>
        <li>{LEGAL.kargoFirmasi} (teslimat)</li>
      ...
      <h2>8. Çerezler</h2>
      <p>
        Sitemizde zorunlu (oturum, sepet, güvenlik) ve tercih çerezleri kullanılır. Ayrıntı için{' '}
